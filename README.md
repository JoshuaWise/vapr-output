...
This plugin is used to define which *media types* can be used for outgoing response bodies. It performs [content negotiation](https://tools.ietf.org/html/rfc7231#section-3.4), ensuring that each client receives the best available media type. It also handles serialization, allowing you to provide arbitrary objects as response bodies instead of just strings or Buffers.
