...
module.exports = ({ encodeUndefined, encodeNull, strictParameters, forced, ...serializers } = {}) => {
	...
	if (forced && strictParameters) throw new TypeError('It doesn\'t make sense to use \'strictParameters\' with \'forced\'');
	...
	return negotiate(definitions, definitions[0].handler, !strictParameters);
};
