...
// TODO: prevent a user from declaring non-utf8 charsets, and possibly add charsets to all text/* media types

module.exports = ({ encodeNull = false, forced = false, ...serializers } = {}) => {
